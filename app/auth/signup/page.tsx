...
export default function SignupPage() {
  return (
    <>
      ...
      <br /> <br /> <br />
      <Container>
        <div className="min-h-screen flex items-center justify-center py-12"> {/* إضافة مسافة من الأعلى لتجنب القرب من الهيدر */}
          <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md border border-zinc-200 dark:border-zinc-800 dark:bg-zinc-900 dark:text-white ">
            <h2 className="text-2xl font-bold mb-6 text-zinc-800 dark:text-white">Create a new account</h2>
            ...
            <form className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-zinc-800 dark:text-white">
                  Full Name
                </label>
                <input
                  id="name"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-zinc-800 dark:text-white">
                  Email
                </label>
                <input
                  id="email"
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-zinc-800 dark:text-white">
                  Password
                </label>
                <input
                  id="password"
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-zinc-800 dark:text-white">
                  Confirm Password
                </label>
                <input
                  id="confirmPassword"
            ...
            {/* Facebook and Google SignUp Buttons */}
